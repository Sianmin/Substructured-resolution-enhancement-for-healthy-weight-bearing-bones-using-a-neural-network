...
if __name__ == '__main__':
    ...
    # Paramters
    [useDis, useSED, test] = [False, False, True]
    [ratio, patch_n] = [10, 8]
    [epochs, batch_size, train_ratio] = [10, 64, 1]
    rp = ratio*patch_n
    now = time.localtime()
    ...
    if test:
        ...
        LR_set_train, LR_set_test, HR_set_train, HR_set_test, BC_train, BC_test, SED_train, SED_test = LoadingDatasets(
            ratio, patch_n,
